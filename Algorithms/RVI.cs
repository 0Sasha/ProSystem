...
{
    [Serializable]
    internal class RVI : IScript, System.ComponentModel.INotifyPropertyChanged
    {
        #region Fields
        ...
        public RVI(string Name) { this.Name = Name; }
        public override string ToString() => "RVI";
        ...
        public void Calculate(Security Symbol)
        {
            ...
            Result = new ScriptResult(ScriptType.OSC, IsGrow, new double[][] { RVI }, iBars.DateTime[^1], 0, Level, OnlyLimit);
        }
    }
}
