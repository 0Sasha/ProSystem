...
{
    [Serializable]
    internal class Stochastic : IScript, System.ComponentModel.INotifyPropertyChanged
    {
        #region Fields
        ...
        public Stochastic(string Name) { this.Name = Name; }
        ...
        public void Calculate(Security Symbol)
        {
            ...
            Result = new ScriptResult(ScriptType.OSC, IsGrow, new double[][] { Stoch }, iBars.DateTime[^1], 50, Level, OnlyLimit);
        }
    }
}
