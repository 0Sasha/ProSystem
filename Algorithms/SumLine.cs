...
{
    [Serializable]
    internal class SumLine : IScript, System.ComponentModel.INotifyPropertyChanged
    {
        #region Fields
        ...
        {
            get => PerSig;
            set { PerSig = value; NotifyChanged(); }
        }
        ...
        public SumLine(string Name) { this.Name = Name; }
        public override string ToString() => "SumLine";
