...
{
    [Serializable]
    internal class MFI : IScript, System.ComponentModel.INotifyPropertyChanged
    {
        #region Fields
        ...
        public MFI(string Name) { this.Name = Name; }
        public override string ToString() => "MFI";
        ...
        public void Calculate(Security Symbol)
        {
            ...
            Result = new ScriptResult(ScriptType.OSC, IsGrow, new double[][] { MFI }, iBars.DateTime[^1], 50, Level, OnlyLimit);
        }
    }
}
