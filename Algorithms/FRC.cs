...
{
    [Serializable]
    internal class FRC : IScript, System.ComponentModel.INotifyPropertyChanged
    {
        #region Fields
        ...
        public FRC(string Name) { this.Name = Name; }
        public override string ToString() => "FRC";
        ...
        public void Calculate(Security Symbol)
        {
            ...
            if (OneLevel) Result = new ScriptResult(ScriptType.OSC, IsGrow, new double[][] { FRC }, iBars.DateTime[^1], 0, 0, OnlyLimit);
            else if (UseChannel) Result = new ScriptResult(ScriptType.OSC, IsGrow, new double[][] { FRC, Upper, Lower }, iBars.DateTime[^1], OnlyLimit);
            else Result = new ScriptResult(ScriptType.OSC, IsGrow, new double[][] { FRC, SignalLine }, iBars.DateTime[^1], OnlyLimit);
        }
    }
}
