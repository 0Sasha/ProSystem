...
{
    [Serializable]
    internal class StochRSI : IScript, System.ComponentModel.INotifyPropertyChanged
    {
        #region Fields
        ...
        public StochRSI(string Name) { this.Name = Name; }
        public override string ToString() => "StochRSI";
        ...
        public void Calculate(Security Symbol)
        {
            ...
            Result = new ScriptResult(ScriptType.OSC, IsGrow, new double[][] { StochRSI }, iBars.DateTime[^1], 50, Level, OnlyLimit);
        }
    }
}
