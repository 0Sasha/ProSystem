...
{
    [Serializable]
    internal class DeMarker : IScript, System.ComponentModel.INotifyPropertyChanged
    {
        #region Fields
        ...
        public DeMarker(string Name) { this.Name = Name; }
        public override string ToString() => "DeMarker";
